...
const Register = ({ onLogin }) => {
  ...
  const [showFirstUniverses, setShowFirstUniverses] = useState(false);
  ...
  return <FirstUniverses onUniversesSelected={() => navigate('/')} />; // Redirect to home after universes selection
};
